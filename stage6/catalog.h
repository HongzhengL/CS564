...
class RelCatalog : public HeapFile {
   public:
    ...
    const Status createRel(const string &relation, const int attrCnt, const attrInfo attrList[]);
...
class AttrCatalog : public HeapFile {
   ...
   public:
    ...
    const Status getInfo(const string &relation, const string &attrName, AttrDesc &record);
    ...
    const Status getRelInfo(const string &relation, int &attrCnt, AttrDesc *&attrs);
